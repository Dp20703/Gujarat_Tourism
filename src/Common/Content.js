    ...
    return (
        <>
            ...
            <Card className="m-3">
                ...
                <Card.Header >
                    About Gujarat</Card.Header>
                <Container>
                    <Card.Body>
                        <p className="mt-5 text-xxl">Aavo Padharo, words of welcome in the language of Gujarat because it is here that these words ring truly and the guest is 'God' and the people of Gujarat are gregariously friendly, inviting and will entice you to come again and again.<br /><br />
